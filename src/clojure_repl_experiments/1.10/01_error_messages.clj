(ns clojure-repl-experiments.1.10.error-messages)
...
(let [x])
;;=> Syntax error macroexpanding clojure.core/let at (clojure-repl-experiments:localhost:49677(clj)*:113:39).
...
(def 5) 
;;=> Syntax error compiling def at (clojure-repl-experiments:localhost:49677(clj)*:125:39).
;;   First argument to def must be a Symbol
;; VS 1.9
;;   Syntax error compiling def at (clojure-repl-experiments:localhost:49965(clj)*:46:32).
;;   First argument to def must be a Symbol
