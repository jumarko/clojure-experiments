(ns clojure-repl-experiments.ground-up.debugging
...
(comment
  ...
  ;;            debugging.clj:   17  clojure-repl-experiments.ground-up.debugging/frame
  ;;            debugging.clj:   13  clojure-repl-experiments.ground-up.debugging/frame
  ...
  ;;            debugging.clj:   55  clojure-repl-experiments.ground-up.debugging/total-wood
  ;;            debugging.clj:   46  clojure-repl-experiments.ground-up.debugging/total-wood
  ;;                     REPL:  261  clojure-repl-experiments.ground-up.debugging/eval17431
  ;;                     REPL:  255  clojure-repl-experiments.ground-up.debugging/eval17431
...
(comment
  ...
  ;; debugging.clj:   64  clojure-repl-experiments.ground-up.debugging/total-wood
  ;; debugging.clj:   46  clojure-repl-experiments.ground-up.debugging/total-wood
