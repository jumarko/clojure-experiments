...
;; - see https://github.com/nextjournal/clerk-demo/blob/main/notebooks/data_science.clj
;; - datasets have been copied from https://github.com/nextjournal/clerk-demo/tree/main/datasets
...
(def cia-factbook
  (csv/read-csv (io/file "resources/datasets/cia-factbook.tsv")))
...
(def expectancy-and-gini
  (->> (load-first-sheet "resources/datasets/countries-gini.xlsx")
...
(def world-happiness
  (let [_run-at #inst "2021-11-26T08:28:29.445-00:00" ; bump this to re-run the query!
        ds (jdbc/get-datasource {:dbtype "sqlite" :dbname "resources/datasets/happiness.db"})]
