...
#_(r/read-string (slurp "src/clojure_experiments/experiments.clj"))

#_(re/read-string (slurp "src/clojure_experiments/experiments.clj"))


;;; sjacket: https://github.com/cgrand/sjacket/blob/master/test/net/cgrand/sjacket/test.clj
#_(sjp/parser (slurp "/Users/jumar/workspace/clojure/clojure-experiments/src/clojure_experiments/experiments.clj"))
...
#_(eastwood.analyze-ns/analyze-file "src/clojure_experiments/experiments.clj"
                                  :opt {:debug #{:none}
                                        :callback #(println %)})
